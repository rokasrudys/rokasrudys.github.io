...
export default function Footer(props) {
    ...
    return <footer className="bg-black py-6 mt-20 text-sm text-white text-center fontCard fixed bottom-0 left-0 right-0">
        <a href={'https://github.com/rokasrudys/rokasrudys.github.io'} >
            <button className='hover:text-theme-accent-200 hover:scale-110'>
                ...
                <div className='stroke-white mt-2 mx-auto'>
