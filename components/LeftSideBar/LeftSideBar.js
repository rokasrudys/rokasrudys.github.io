...
export default function LeftSideBar() {
    ...
    return <div orientation="left" className='z-50 fixed hidden md:block w-36 h-36 bottom-0 right-auto drop-shadow-2xl bg-white border-t-10 border-r-2 border-black  rounded-tr-full rounded-br-3xl'>
        <div className="mx-auto pl-2 mt-6">
            <ul className=''>
                <li className='flex flex-row'>
                    <a href="mailto:rokas.jobs@gmail.com" aria-label="Email"><svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 23 23" fill="none" strokeWidth="1.3" width="100%" height="3rem" className="stroke-slate-900 hover:stroke-theme-accent-800 hover:scale-110 drop-shadow-lg hover:animate-pulse mr-2">
                        <title>Email</title>
                ...
                <div className="flex flex-row">
                    <li>
                        <a href="https://github.com/rokasrudys" aria-label="GitHub"><svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 23 23" fill="none" strokeWidth="1.3" width="100%" height="3rem"  className="stroke-slate-900 hover:stroke-theme-accent-800 hover:scale-110 hover:animate-pulse drop-shadow-lg mr-2">
                            <title>GitHub</title> 
                    ...
                    <li>
                        <a href="https://www.linkedin.com/in/rokasrudys/" aria-label="Linkedin"><svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 23 23" fill="none" strokeWidth="1.3" width="100%" height="3rem" className="stroke-slate-900 hover:stroke-theme-accent-800 hover:scale-110 drop-shadow-lg hover:animate-pulse ">
